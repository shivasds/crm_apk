...
<div class="footer-menu footer-4-icons footer-menu-center-icon">
            <a href="<?=base_url('search_callback');?>" class="<?= $this->uri->segment(1) == 'search_callback' ? 'active-nav' : '' ?>" onclick="showloader()"><i class="fa fa-file"></i><span>Search</span></a>
            <a href="<?=base_url('imp_callbacks');?>" class="<?= $this->uri->segment(1) == 'imp_callbacks' ? 'active-nav' : '' ?>" onclick="showloader()"><i class="fa fa-gift "></i><span>Favourates</span></a>
